...
import com.xx.demo.entity.J2SEImage;
...
public class QRCodeUtil {
    public static void qrCodeEncode(String encodeddata, File destFile) throws IOException {
        ...
        Image img = ImageIO.read(new File("D:/tt.jpg"));  //logo
        g.drawImage(img, 51, 51,35,35, null);
...
//              System.out.println("Output Decoded Data is：" + decodedData);
    ...
    public static void main(String[] args) {
        ...
        // 二维码内容
        String encodeddata = "http://jwc.njxzc.edu.cn/";
        try {
